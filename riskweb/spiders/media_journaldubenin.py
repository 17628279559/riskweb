...
class MediaJournaldubeninSpider(scrapy.Spider):
    name = 'media_journaldubenin'
    allowed_domains = ['journaldubenin.com']

    def start_requests(self):
        #开始爬取网址
        start_urls = [
            'https://www.journaldubenin.com/category/politique/',
            'https://www.journaldubenin.com/category/eco-et-business/',
            'https://www.journaldubenin.com/category/societe/',
            'https://www.journaldubenin.com/category/sport/',
            'https://www.journaldubenin.com/category/culture/',
            'https://www.journaldubenin.com/category/sante/',
            'https://www.journaldubenin.com/category/opinions/',
            'https://www.journaldubenin.com/category/personnalites/',
            'https://www.journaldubenin.com/category/dossiers/',
            'https://www.journaldubenin.com/category/international/',
        ]
        # 发送请求
