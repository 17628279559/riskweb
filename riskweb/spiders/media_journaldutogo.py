...
class MeidaJournaldutogoSpider(scrapy.Spider):
    name = 'meida_journaldutogo'
    allowed_domains = ['journaldutogo.com']

    def start_requests(self):
        #开始爬取网址
        start_urls = [
            'https://www.journaldutogo.com/category/politique/',
            'https://www.journaldutogo.com/category/eco-et-business/',
            'https://www.journaldutogo.com/category/societe/',
            'https://www.journaldutogo.com/category/sport/',
            'https://www.journaldutogo.com/category/culture/',
            'https://www.journaldutogo.com/category/sante/',
            'https://www.journaldutogo.com/category/opinions/',
            'https://www.journaldutogo.com/category/personnalites/',
            'https://www.journaldutogo.com/category/dossiers/',
            'https://www.journaldutogo.com/category/international/',
        ]
        # 发送请求
