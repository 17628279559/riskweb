...
class MediaJournaldumaliSpider(scrapy.Spider):
    name = 'media_journaldumali'
    allowed_domains = ['journaldumali.com']

    def start_requests(self):
        #开始爬取网址
        start_urls = [
            'https://www.journaldumali.com/category/politique/',
            'https://www.journaldumali.com/category/economie/',
            'https://www.journaldumali.com/category/societe/',
            'https://www.journaldumali.com/category/sport/',
            'https://www.journaldumali.com/category/culture/',
            'https://www.journaldumali.com/category/sante/',
            'https://www.journaldumali.com/category/opinions/',
            'https://www.journaldumali.com/category/personnalites/',
            'https://www.journaldumali.com/category/idees/',
            'https://www.journaldumali.com/category/international/',
        ]
        # 发送请求
