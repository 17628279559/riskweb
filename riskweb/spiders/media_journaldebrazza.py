...
class MediaJournaldebrazzaSpider(scrapy.Spider):
    name = 'media_journaldebrazza'
    allowed_domains = ['journaldebrazza.com']

    def start_requests(self):
        # 开始爬取网址
        start_urls = [
            'https://www.journaldebrazza.com/category/politique/',
            'https://www.journaldebrazza.com/category/eco-et-business/',
            'https://www.journaldebrazza.com/category/societe/',
            'https://www.journaldebrazza.com/category/sport/',
            'https://www.journaldebrazza.com/category/culture/',
            'https://www.journaldebrazza.com/category/sante/',
            'https://www.journaldebrazza.com/category/opinions/',
            'https://www.journaldebrazza.com/category/personnalites/',
            'https://www.journaldebrazza.com/category/dossiers/',
            'https://www.journaldebrazza.com/category/international/',
        ]
        # 发送请求
