...
class MediaJournaldutchadSpider(scrapy.Spider):
    name = 'media_journaldutchad'
    allowed_domains = ['journaldutchad.com']

    def start_requests(self):
        # 开始爬取网址
        start_urls = [
            'https://www.journaldutchad.com/category/politique/',
            'https://www.journaldutchad.com/category/eco-et-business/',
            'https://www.journaldutchad.com/category/societe/',
            'https://www.journaldutchad.com/category/sport/',
            'https://www.journaldutchad.com/category/culture/',
            'https://www.journaldutchad.com/category/sante/',
            'https://www.journaldutchad.com/category/opinions/',
            'https://www.journaldutchad.com/category/personnalites/',
            'https://www.journaldutchad.com/category/dossiers/',
            'https://www.journaldutchad.com/category/international/',
        ]
        # 发送请求
